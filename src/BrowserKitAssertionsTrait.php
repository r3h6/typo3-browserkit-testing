...
trait BrowserKitAssertionsTrait
{
    ...
    {
        self::assertThat(WebTestCase::getTypo3Client(), $constraint, $message);
    }

    private static function getResponse(): Response
    {
        if (!$response = WebTestCase::getTypo3Client()->getResponse()) {
    ...
    {
        if (!$request = WebTestCase::getTypo3Client()->getRequest()) {
